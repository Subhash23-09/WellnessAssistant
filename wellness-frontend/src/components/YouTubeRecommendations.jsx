  ...
  const renderCard = (v, i, extra = "") => (
    ...
    >
      <div className="relative">
        <img
          src={v.thumbnail || "/src/assets/youtube-logo.png"}
          alt={v.title || "Wellness video"}
          className="w-full h-40 object-cover"
          onError={(e) => {
            if (e.currentTarget.src !== "/src/assets/youtube-logo.png") {
              e.currentTarget.src = "/src/assets/youtube-logo.png";
            }
          }}
        />
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-0 mb-6 p-4 rounded-xl bg-gradient-to-r from-emerald-50 to-white border border-emerald-100">
        <div className="flex items-start sm:items-center gap-3 sm:gap-4">
          <img
            ...
            onError={(e) => {
              if (e.currentTarget.src !== "/src/assets/youtube-logo.jpg")
                e.currentTarget.src = "/src/assets/youtube-logo.jpg";
            }}
          />
